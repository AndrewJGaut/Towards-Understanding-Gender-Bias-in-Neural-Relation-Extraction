...
def fetch_harddebiased(normalize=True, lower=False, clean_words=False):
    """
    ...
    """
    path = _fetch_file(url="https://drive.google.com/file/d/1NH6jcrg8SXbnhpIXRIXF_-KUE7wGxGaG/view?usp=sharing",
                           data_dir="embeddings",
                           verbose=1)
    return load_embedding(path, format="word2vec_bin", normalize=normalize, lower=lower, clean_words=clean_words)
